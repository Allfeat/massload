    ...
    view! {
        <div class="register-page">
            ...
            <div class="register-hero">
                <h1>{move || t("register.hero_title")}</h1>
                <p class="register-subtitle">{move || t("register.hero_subtitle")}</p>
            </div>
            ...
            <div class="register-groups">
                ...
                <div class="register-group">
                    <div class="group-header">
                        ...
                        <span class="group-title">{move || t("register.group_parties")}</span>
                    </div>
                    <div class="group-cards">
                        <A href="/register-artist" class="midds-card coming-soon">
                            <span class="card-icon"><IconUser/></span>
                            <span class="card-label">{move || t("register.artist.title")}</span>
                        </A>
                        <A href="/register-legal-entity" class="midds-card coming-soon">
                            <span class="card-icon"><IconBuilding/></span>
                            <span class="card-label">{move || t("register.legal_entity.title")}</span>
                        </A>
                    </div>
                    <p class="group-note">{move || t("register.parties_note")}</p>
                </div>
                ...
                <div class="register-group">
                    <div class="group-header">
                        ...
                        <span class="group-title">{move || t("register.group_products")}</span>
                    </div>
                    <div class="group-cards">
                ...
                <div class="massload-card">
                    <div class="massload-content">
                        ...
                        <div class="massload-text">
                            <h3>{move || t("register.massload_title")}</h3>
                            <p>{move || t("register.massload_desc")}</p>
                        </div>
                    </div>
                    <A href="/massload" class="massload-btn">
                        {move || t("register.go_to_massload")}
                        <IconArrowRight/>
                    </A>
                </div>
            </div>
    ...
    view! {
        <div class="register-form-page">
            <div class="form-header">
                <A href="/register" class="back-link">"← " {move || t("register.back")}</A>
                <h1>{move || t("register.recording.title")}</h1>
                <p>{move || t("register.recording.form_desc")}</p>
            </div>
            
            <div class="form-container">
                <div class="form-section">
                    <h3>{move || t("register.form.basic_info")}</h3>
                    
                    <div class="form-group">
                        <label for="isrc">{move || t("register.form.isrc")} " *"</label>
                        <input type="text" id="isrc" class="form-input" placeholder="USRC10000001" />
                    </div>
                    
                    <div class="form-group">
                        <label for="work_iswc">{move || t("register.form.linked_work")}</label>
                        <input type="text" id="work_iswc" class="form-input" placeholder="T-000.000.000-0" />
                        <span class="form-hint">{move || t("register.form.linked_work_hint")}</span>
                    </div>
                    
                    <div class="form-group">
                        <label for="duration">{move || t("register.form.duration")}</label>
                ...
                <div class="form-actions">
                    <button class="btn btn-primary" disabled>
                        {move || t("register.form.submit")}
                    </button>
                    <span class="form-notice">{move || t("register.form.wallet_required")}</span>
                </div>
            </div>
        </div>
    }
...
pub fn RegisterReleasePage() -> impl IntoView {
    view! {
        <div class="register-form-page">
            <div class="form-header">
                <A href="/register" class="back-link">"← " {move || t("register.back")}</A>
                <h1>{move || t("register.release.title")}</h1>
                <p>{move || t("register.release.form_desc")}</p>
            </div>
            ...
            <div class="form-container">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label for="title">{move || t("register.form.release_title")} " *"</label>
                        <input type="text" id="title" class="form-input" />
                    </div>
                    
                    <div class="form-row">
                        <div class="form-group">
                            <label for="release_date">{move || t("register.form.release_date")}</label>
                            <input type="date" id="release_date" class="form-input" />
                        </div>
                        <div class="form-group">
                            <label for="upc">{move || t("register.form.upc")}</label>
    ...
    view! {
        <div class="coming-soon-page">
            <div class="coming-soon-content">
                <div class="coming-soon-icon"><IconUser/></div>
                <h1 class="coming-soon-title">{move || t("register.artist.title")}</h1>
                <p class="coming-soon-description">{move || t("register.artist.coming_soon")}</p>
                <A href="/register" class="coming-soon-link">
                    "← " {move || t("register.back")}
                </A>
            </div>
        </div>
    }
...
pub fn RegisterLegalEntityPage() -> impl IntoView {
    view! {
        <div class="coming-soon-page">
            <div class="coming-soon-content">
                <div class="coming-soon-icon"><IconBuilding/></div>
                <h1 class="coming-soon-title">{move || t("register.legal_entity.title")}</h1>
                <p class="coming-soon-description">{move || t("register.legal_entity.coming_soon")}</p>
                <A href="/register" class="coming-soon-link">
                    "← " {move || t("register.back")}
                </A>
            </div>
