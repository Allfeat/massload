...
pub fn translate(key: &str, lang: Language) -> Option<&'static str> {
    match key {
        ...
        "home.explore.title" => Some(match lang {
            ...
            Language::Korean => "탐색",
            Language::Greek => "Εξερευνήστε",
        }),
        "home.explore.desc" => Some(match lang {
            Language::English => "Browse and search the on-chain music industry database.",
            Language::French => "Parcourez et recherchez la base de données musicale on-chain.",
            Language::Spanish => "Busque en la base de datos de la industria musical on-chain.",
            Language::German => "Durchsuchen Sie die On-Chain-Musikindustrie-Datenbank.",
            Language::Japanese => "オンチェーン音楽業界データベースを検索。",
            Language::Korean => "온체인 음악 산업 데이터베이스 검색.",
            Language::Greek => "Αναζητήστε στη βάση δεδομένων μουσικής βιομηχανίας on-chain.",
        }),
